...
<ul>
  ...
  <li><a class="active" href="#">View Ticket</a></li>
  <li><a href="cancelticket.jsp">Cancel Ticket</a></li>
  <li><a href="viewtrain.jsp">Cancel Ticket</a></li>
...
<br><br>
<center>
<h1>Click below button to View Ticket</h1>
<form action="viewticket" method="POST">
<input type="text" name="viewemail" placeholder="enteremail"/>
